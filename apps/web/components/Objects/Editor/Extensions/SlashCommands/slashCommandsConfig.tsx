...
export const slashCommands: SlashCommandItem[] = [
  ...
  // Interactive category
  {
    ...
    icon: <div style={{ background: 'conic-gradient(from 32deg at 53.75% 50%, rgb(35, 40, 93) 4deg, rgba(20, 0, 52, 0.95) 59deg, rgba(164, 45, 238, 0.88) 281deg)' }} className="p-1 rounded-md"><Image src={aiIcon} alt="Magic Block" width={14} height={14} className="outline outline-1 outline-neutral-200/20 rounded" /></div>,
