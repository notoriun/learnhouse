# Checklist de Qualidade da Especificação: Administração da Configuração OIDC
...
- Limite de um provedor ativo por organização no primeiro release documentado em Premissas.
- Mapeamento de grupos (P2) fora do escopo, previsto como extensão futura desta tela.
