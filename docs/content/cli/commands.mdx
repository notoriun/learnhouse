...
Then check the [LearnHouse releases page](https://github.com/notoriun/learnhouse/releases) and the [GitHub issues](https://github.com/notoriun/learnhouse/issues) for your version before retrying.
