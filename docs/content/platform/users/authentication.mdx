...
- **Google OAuth** — third-party social login provider.
- **Corporate login (Keycloak/OIDC)** — federated identity with the platform's Keycloak or a per-organization OIDC provider, including federated sign-up and one-shot user migration — see [Login Corporativo](/platform/users/corporate-login).
