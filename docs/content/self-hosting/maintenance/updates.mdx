...
Review the [LearnHouse release notes](https://github.com/notoriun/learnhouse/releases) before updating to understand what has changed. Some updates may include:
